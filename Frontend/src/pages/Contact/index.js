            ...
            <div className={cx('inner')}>
                <div className={cx('inner-left')}>
                    ...
                    <form className={cx('form')}>
                        ...
                        <div className={cx('form-group')}>
                            <textarea rows="14" cols="63" className={cx('form-message')} name="user_message" />
                        </div>
                        {/* Btn */}
                        <Button primary className={cx('frm-btn')}>
                            Gửi
                        </Button>
                    </form>
                    <hr />
                    ...
                    <div className={cx('information')}>
                        <div className={cx('address')}>
                            ...
                            <div className={cx('content')}>
                                <p>QTSC 9, Công viên phần mềm Quang Trung, Tân Chánh Hiệp, Quận 12, TP HCM</p>
                            </div>
                        </div>
                ...
                <div className={cx('inner-right')}>
                    <iframe
                        src={
                            'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.4439805400953!2d106.62348867486979!3d10.853796757762131!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752a20d8555e69%3A0x743b1e9558fb89e0!2sQTSC%209%20Building!5e0!3m2!1svi!2s!4v1699261324571!5m2!1svi!2s'
                        }
                        loading="lazy"
                        allowFullScreen=""
                        referrerPolicy="no-referrer-when-downgrade"
