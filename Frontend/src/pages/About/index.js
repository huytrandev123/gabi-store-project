        ...
        <div className={cx('wrapper')}>
                    ...
                    <div className={cx('content')}>
                        <div className={cx('content-left')}>
                            <p>
                                ...
                                hình thành và phát triển, Gabi Store hoàn thiện chuỗi hệ thống bán lẻ với 45 cửa hàng
                        ...
                        <div className={cx('content-right')}>
                            <p>
                                Hiện nay, Gabi Store đã trở thành thương hiệu thời trang với “chất” riêng dành cho các
                                bạn nam, nữ trẻ năng động, phóng khoáng và yêu thích trải nghiệm. Gabi Store không ngừng
            ...
            <div className={cx('fashion')}>
                ...
                <div className={cx('fashion-right')}>
                    ...
                    <p className={cx('desc')}>
                        Gabi Store chú trọng phát triển những sản phẩm hướng đến thời trang bền vững bằng việc sử dụng
                        các chất liệu thân thiện với môi trường như: vải cotton, vải lanh, vải café, vải nhựa tái chế,…
                        Bên cạnh đó, Gabi Store còn thực hiện các chiến dịch nhằm nâng cao nhận thức của người tiêu dùng
